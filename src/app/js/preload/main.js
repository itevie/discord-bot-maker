...
contextBridge.exposeInMainWorld("ipcApi", {
    ...
    restartBot: (name) => ipcRenderer.send("bot:restart-bot", name),
    ...
    changeSelectedBot: (data) => ipcRenderer.send("bot:change-selected", data),
    getGuildList: (data) => ipcRenderer.sendSync("bot:get-bot-guilds", data),
    leaveServer: (bot, guild) => ipcRenderer.sendSync("bot:leave-server", { bot, guild }),
    getPage: (name) => ipcRenderer.sendSync("get-page", name),
    getModal: (name) => ipcRenderer.sendSync("get-modal", name),
    getKnownEventList: () => ipcRenderer.sendSync("events:get-known-list", null),
    editEvent: (name) => ipcRenderer.send("events:edit", name),
