import * as styles from "./init_styles.js";
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  initLocale("main", () => {
    ...
    let langSelect = document.getElementById("app-settings-language-select") as HTMLSelectElement;
    ...
    if (!ipc.getCurrentBot()) {
      ...
      ].forEach(x => (document.querySelector(x) as HTMLElement).style.display = "none");
      (document.querySelector(`[data-div-changer="welcome"]`) as HTMLButtonElement).click();
      (document.querySelector(`[data-div-changer="welcome"]`) as HTMLButtonElement).style.display = "block";
